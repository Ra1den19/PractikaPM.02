...
namespace MedLab
{
    public partial class Laborant_Auth : Form
    {
        ...
        private void Enter_button_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from [Данные лаборантов] where логин = @login and пароль = @password";
            ...
            if (rd.HasRows)
            {
                while (rd.Read())
                {
                    ...
                    {
                        MessageBox.Show($"Вы успешно авторизованы как администратор, здравствуйте, {login}");
                        log.Clear();
                        par.Clear();
                    }
                }
